...
We use open source every day. Sharing our own tools is how we give back. Everything here is code we actually use in production – built for speed, tested in real projects.

Use it if it helps. Found an issue? Contributions are welcome.

:link: [fjellvarden.no](https://fjellvarden.no)
